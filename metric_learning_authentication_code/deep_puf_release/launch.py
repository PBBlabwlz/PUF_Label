...
def main(args, extras) -> None:
    ...
    if args.typecheck:
        ...
        install_import_hook("dmp", "typeguard.typechecked")

    import dmp
    from dmp.systems.base import BaseSystem
    from dmp.utils.callbacks import (
        CodeSnapshotCallback,
        ConfigSnapshotCallback,
        CustomProgressBar,
        ProgressCallback,
    )
    from dmp.utils.config import ExperimentConfig, load_config
    from dmp.utils.misc import get_rank, time_recorder
    from dmp.utils.typing import Optional
    ...
    dm = dmp.find(cfg.data_cls)(cfg.data)
    system: BaseSystem = dmp.find(cfg.system_cls)(
